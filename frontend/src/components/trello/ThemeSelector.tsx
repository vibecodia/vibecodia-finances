...
import { FolderKanban, Layout, Plus, Crown, AlertCircle, Settings } from 'lucide-react';
...
export function ThemeSelector({ themes, tasks, onSelectTheme, onAddTheme, onUpdateTheme, onDeleteTheme }: ThemeSelectorProps) {
          ...
          <div key={theme.id} className="group relative">
            ...
            >
              ...
              <div 
                className={cn(
                  ...
                  theme.backgroundImage ? "bg-white/20 text-white backdrop-blur-md" : "bg-primary/10 text-primary"
                )}
                style={!theme.backgroundImage && theme.color ? { color: theme.color, backgroundColor: `${theme.color}15` } : {}}
              >
              ...
              <div>
                <h3 className={cn(
                  ...
                  theme.backgroundImage ? "text-white" : "text-foreground group-hover:text-primary"
                )}>
                  {theme.name}
                </h3>
                {theme.subtitle && (
            ...
            <button
              ...
              className={cn(
                ...
                theme.backgroundImage ? "bg-white/20 text-white hover:bg-white/40" : "bg-foreground/5 text-muted-foreground hover:bg-primary/10 hover:text-primary"
              )}
