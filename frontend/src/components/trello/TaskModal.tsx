...
export function TaskModal({
  ...
  const availableTasks = useMemo(() => {
    return allTasks.filter(
      (t) => t.id !== task?.id && t.columnId !== "archived",
    );
  }, [allTasks, task]);
  ...
  const toggleDependency = (depId: string) => {
    if (dependsOn.includes(depId)) {
      ...
      if (task?.id && hasCycle(task.id, depId, allTasks)) {
        alert(
          "Esta dependência criaria um ciclo (A depende de B e B depende de A).",
        );
        return;
      }
    ...
    >
      ...
      >
        ...
        <form
          ...
          className="flex-1 p-8 space-y-6 overflow-y-auto custom-scrollbar"
        >
          <div
            className={cn(
          ...
          >
            <div
              className={cn("space-y-6", isFullscreen ? "md:col-span-8" : "")}
            >
              <Input
                label="Título *"
                type="text"
                  ...
                  {mode === "edit" && (
                    <div className="flex flex-wrap items-center gap-2">
                      {task?.columnEnteredAt && (
                        <div
                          className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-foreground/5 text-muted-foreground text-[10px] font-bold"
                      ...
                      {task?.createdAt && (
                        <div
                          className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-primary/5 text-primary text-[10px] font-bold"
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={cn(
                        ...
                        isPinned
                          ...
                          : "bg-foreground/5 text-muted-foreground group-hover:text-primary",
                      )}
                    >
                      <Pin
                    ...
                    >
                      {isPinned
                        ? "Tarefa Fixada no Topo"
                        : "Manter no Topo da Coluna"}
                    </span>
                  </div>
                  <div
                    className={cn(
            ...
            <div
              className={cn("space-y-6", isFullscreen ? "md:col-span-4" : "")}
            >
              <div className="space-y-3">
                <label className="text-sm font-black text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                            ...
                            {(provided, snapshot) => (
                              <div
                                ...
                                className={cn(
                                  ...
                                  snapshot.isDragging &&
                                    "shadow-xl bg-card border-primary/20 scale-[1.02] z-50",
                                )}
                              >
                                <div
              ...
              <div className="space-y-4 pt-6 border-t border-border">
                ...
                <div className="space-y-2 mt-4 max-h-[200px] overflow-y-auto pr-2 custom-scrollbar">
                  {timeLogs.map((log) => (
                    <div
                      key={log.id}
                      className="flex items-center justify-between p-3 rounded-xl bg-foreground/5 group hover:bg-foreground/10 transition-all border border-transparent hover:border-primary/10"
                    >
