...
export const Column = React.memo(({ 
  ...
  const getColumnColor = () => {
    ...
    if (id.includes('inProgress')) return 'border-amber-500/20 bg-amber-500/5';
      ...
      <div className="mb-6 flex flex-col px-2">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1 ml-2">
            ...
            >
              {isMinimal ? <Maximize2 className="w-4 h-4" /> : <Minimize2 className="w-4 h-4" />}
            </Button>
            {id !== 'archived' && (
              <Button
        ...
        <div className={cn("w-12 h-1.5 rounded-full", getAccentColor())}></div>
      </div>
