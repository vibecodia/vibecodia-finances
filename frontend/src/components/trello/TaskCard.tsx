...
const FlagIcon = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-1 px-1.5 py-0.5 rounded bg-foreground/5",
        color,
      )}
      title={label}
    >
...
export const TaskCard = React.memo(
  ({
    ...
    const isMinimal =
      !isFocusMode && (isMinimalOverride ?? isDone) && !hasSearchMatch;
    ...
    const CardContent = (
      <Card
        ...
        className={cn(
          ...
          isFocusMode
            ? "p-8 shadow-2xl border-2 border-primary/20 bg-card max-w-3xl w-full mx-auto"
            : isMinimal
      ...
      >
        ...
        {!isFocusMode && (
          ...
          >
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {isBlocked && (
                <div
                  className="flex items-center gap-1 px-1.5 py-0.5 rounded bg-red-500/10 text-red-500"
                  title={`Depende de ${pendingDependencies.length} tarefa(s) pendente(s)`}
                >
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              ...
              >
                <Pin
                  className={cn("w-3.5 h-3.5", task.isPinned && "fill-current")}
                />
              </Button>
              {!isMinimal && (
                <Button
              ...
              <Button
                ...
                title={
                  task.columnId === "archived" ? "Desarquivar" : "Arquivar"
                }
              >
        ...
        >
          ...
          {isMinimal && isBlocked && (
            <Link2 className="w-3 h-3 text-red-500 shrink-0 mt-1" />
          )}
          <h3
            className={cn(
        ...
        {task.description && !isMinimal && (
          <div
            className={cn(
              ...
              isFocusMode
                ? "text-base mb-10 leading-relaxed"
        ...
        {totalItems > 0 && !isMinimal && (
          <div
            className={cn(isFocusMode ? "space-y-8 mb-10" : "space-y-3 mb-4")}
          >
            <div className="flex items-center gap-2">
              <CheckSquare
                className={cn(
                  "text-primary",
                  isFocusMode ? "w-6 h-6" : "w-3.5 h-3.5",
                )}
              />
              <div
                className={cn(
                  "flex-1 bg-foreground/5 rounded-full overflow-hidden",
                  isFocusMode ? "h-3" : "h-1.5",
                )}
              >
                <div
              ...
              <span
                className={cn(
                  ...
                  isFocusMode ? "text-base" : "text-[10px]",
                )}
              >
                ...
                return (
                  ...
                  >
                    {item.completed ? (
                      <CheckSquare
                        className={cn(
                          "text-primary group-hover/item:scale-110 transition-transform",
          ...
          >
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span
                  className={cn(
                    "font-black uppercase tracking-widest text-muted-foreground",
                    isFocusMode ? "text-sm" : "text-[10px]",
                  )}
                >
              ...
              {totalLoggedHours > 0 && (
                <div
                  className={cn(
                    "flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-primary/5 text-primary border border-primary/10",
                    isFocusMode ? "text-sm" : "text-[10px]",
                  )}
                >
              ...
              <div
                className={cn(
                  "flex flex-wrap items-center gap-3 text-muted-foreground opacity-60",
              ...
              >
                ...
                <div
                  ...
                  title="Tempo total desde a criação"
                >
            ...
            {task.date && (
              <div
                className={cn(
                  ...
                  parseLocalDate(task.date.toString()) <
                    getCurrentBrazilDate() && task.columnId !== "done"
                    ? "text-destructive"
