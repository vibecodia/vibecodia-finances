          ...
          return (
            <Card 
              ...
              className={cn(
                ...
                plan.highlight ? "border-primary shadow-[0_20px_40px_-12px_rgba(var(--primary),0.2)] bg-primary/5" : "border-white/5 bg-card/40"
              )}
            >
              {plan.highlight && (
              ...
              <div className="mb-8">
                <div className={cn(
                  ...
                  plan.highlight ? "bg-primary text-primary-foreground shadow-lg shadow-primary/20" : "bg-white/5 text-foreground"
                )}>
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  {plan.period && <span className="text-sm text-muted-foreground font-bold">{plan.period}</span>}
                </div>
                ...
                {plan.features.map((feature) => (
                  <div key={feature} className="flex items-center gap-3">
                    <div className={cn(
                      ...
                      plan.highlight ? "bg-primary/20 text-primary" : "bg-white/5 text-muted-foreground"
                    )}>
